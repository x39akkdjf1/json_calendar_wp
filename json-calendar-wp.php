...
final class JSON_Calendar_WP {
	...
	public function render_shortcode( $atts ) {
		...
		if ( false === $data ) {
			$response = wp_safe_remote_get( $url, array( 'timeout' => 10, 'headers' => array( 'Accept' => 'application/json' ), 'user-agent' => 'JSON Calendar WordPress Plugin/1.6.3' ) );
